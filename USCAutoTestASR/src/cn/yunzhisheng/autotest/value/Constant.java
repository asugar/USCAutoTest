...
public class Constant {
	...
	// 测试配置
	public static TestConfigBean testConfig = null;

	// 编码格式utf-8
	public static final String ENCODE = "gbk";

	// 测试任务单
	public static TaskBean task = null;

	// 测试任务地址
	public final static String TASK_URI = "http://10.10.11.104:8081/pullTask.action?userName=admin&os=Android&scheme=common&version=2.0";
